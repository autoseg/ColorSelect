...
| *Variable*                  | *Function*                              | *Default*   | *Possibles*           |
| _g:FormatResultColorSelect_ | Sets the format returned by ColorSelect | hexadecimal | 'hex' or 'rgba'       |
| _g:CaseResultColorSelect_   | Sets, in hex mode, case of return       | upcase      | 'upcase' or 'dowcase' |
